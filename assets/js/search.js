(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-smartnation-strategy'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-smartnation-strategy/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "Smart Nation: The Way Forward"
