(function () {
    ...
    editButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            var repoUrl = 'https://github.com/opendocsg/opendoc-smartnation-strategy' + '/blob/master/'
    ...
    printButtons.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            var replacedRepoName = 'opendocsg/opendoc-smartnation-strategy'.replace(/\//g, '-') + (isProd ? '' : '-staging')
            var pdfUrl = 'true' === 'true' ?
                '/opendoc-smartnation-strategy/assets/pdfs' :
    ...
    shareButtons.forEach(function(btn) {
        btn.addEventListener('click', function() {
            if (navigator.share) {
                navigator.share({
                    title: "Smart Nation: The Way Forward",
                    text: document.title,
